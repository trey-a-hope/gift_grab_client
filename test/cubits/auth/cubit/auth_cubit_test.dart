...
//       when(
//         () => mockSocialAuthService.googleSignIn,
...
//         ),
//         seed: () =>
//             const AuthState(authenticated: true, isLoading: false, error: null),
//         act: (cubit) => cubit.logout(),
//         expect: () => [
//           const AuthState(authenticated: true, isLoading: true, error: null),
//           const AuthState(authenticated: false, isLoading: false, error: null),
//         ],
//       );
...
//         setUp: () {
//           when(
//             () => mockNakamaBaseClient.authenticateEmail(
...
//           when(
//             () => mockSessionService.saveSession(mockSession),
...
//         expect: () => [
//           const AuthState(authenticated: false, isLoading: true, error: null),
//           const AuthState(authenticated: true, isLoading: false, error: null),
//         ],
//       );
...
//           when(
//             () => mockSessionService.shouldRefreshSession(mockSession),
//           ).thenReturn(false);
//         },
//         build: () => AuthCubit(
//           mockNakamaBaseClient,
...
//           when(
//             () => mockSessionService.refreshSession(mockSession),
//           ).thenAnswer((_) async => mockSession);
//         },
//         build: () => AuthCubit(
//           mockNakamaBaseClient,
